...
if ($res_outer[0]['address_id'] != 0) {
    $user_address = $function->get_data('user_addresses', 'id=' . $res_outer[0]['address_id'], ['area', 'pincode', 'city', 'name', 'mobile']);
}
...
$db->sql($sql);
$res = $db->getResult();
$seller_info = $function->get_data('seller', "id=" . $res_outer[0]['seller_id'], $columns = []);
...
<section class="content">
    ...
    <section class="invoice">
        ...
        <?php for ($i = 0; $i < count($seller_ids); $i++) {
            ...
            $seller_info = $function->get_data('seller', "id=" . $seller_ids[$i], $columns = []);
        ?>
                ...
                <div class="well">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p> Customer Care : <?= $seller_info[0]['mobile'] ?></p>
                        ...
                        <div class="col-md-3">
                            ...
                            if (!empty($res_items[0]['delivery_boy_id'])) {
                                $delivery_noy_name = $function->get_data('delivery_boys', 'id=' . $res_items[0]['delivery_boy_id'], $columns = ['name']);
                            }
                            ?>
