                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="url" placeholder="https://example.com" pattern="https://.*" class="form-control" name="copy_right_url" value="<?= isset($data['copy_right_url']) ? $data['copy_right_url'] : '' ?>" placeholder='Copy Right Url' />
