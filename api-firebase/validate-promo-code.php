    ...
    if (!empty($res)) {
        foreach ($res as $row) {
            ...
            for ($k = 0; $k < count($total); $k++) {
                ...
                //print_r($res);
                if (isset($res[$i]['is_validate'][$k]['total']) && !empty($res[$i]['is_validate'][$k]['total'])) {
                    // if (!empty($res[$i]['is_validate'][$k]['total'] && $res[$i]['is_validate'][$k]['discount'] && $res[$i]['is_validate'][$k]['discounted_amount'])) {
