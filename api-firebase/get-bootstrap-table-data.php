...
if (isset($_GET['table']) && $_GET['table'] == 'offers') {
    ...
    foreach ($res as $row) {
        ...
        if ($row['type'] == "") {
            $tempRow['image'] = "<a data-lightbox='offer' href='" . $row['image'] . "'><video width='40' autoplay><source src='" . $row['image'] . "' type='video/mp4'/></video></a>";
        } else {
            $tempRow['image'] = "<a data-lightbox='offer' href='" . $row['image'] . "'><img src='" . $row['image'] . "' width='40'/></a>";
        }
...
if (isset($_GET['table']) && $_GET['table'] == 'product_sales_report') {
    ...
    foreach ($res as $row) {
        ...
        $seller_info = $fn->get_data('seller', "id=" . $row['seller_id'], $column = ['name', 'store_name']);
